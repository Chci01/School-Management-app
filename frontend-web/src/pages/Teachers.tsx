...
const Teachers = () => {
  ...
  const { users, isLoading, error, deleteUser } = useUsers(currentSchoolId!, 'ENSEIGNANT');
    ...
    <div className="dashboard-container">
      <div className="card-header" style={{ marginBottom: '24px' }}>
        <div>
          ...
          <p style={{ color: 'var(--text-secondary)', marginTop: '4px' }}>Consultez, ajoutez ou modifiez les profils des enseignants.</p>
        </div>
