...
let SchoolsController = class SchoolsController {
    ...
    async generateLicense(days, req) {
    ...
    async activateLicense(id, licenseKey, req) {
        try {
...
], SchoolsController.prototype, "findPublic", null);
__decorate([
    (0, common_1.Post)(),
...
__decorate([
    (0, common_1.Post)('generate-license'),
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard, license_guard_1.LicenseGuard, roles_guard_1.RolesGuard),
    (0, roles_decorator_1.Roles)(roles_decorator_1.Role.SUPER_ADMIN),
...
], SchoolsController.prototype, "generateLicense", null);
__decorate([
    ...
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", Promise)
], SchoolsController.prototype, "getLicenses", null);
__decorate([
    (0, common_1.Get)(),
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard, license_guard_1.LicenseGuard, roles_guard_1.RolesGuard),
    (0, roles_decorator_1.Roles)(roles_decorator_1.Role.SUPER_ADMIN),
...
__decorate([
    (0, common_1.Get)(':id'),
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard, license_guard_1.LicenseGuard, roles_guard_1.RolesGuard),
    (0, roles_decorator_1.Roles)(roles_decorator_1.Role.SUPER_ADMIN, roles_decorator_1.Role.ADMIN_ECOLE),
...
__decorate([
    ...
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", void 0)
], SchoolsController.prototype, "toggleActive", null);
__decorate([
    (0, common_1.Post)(':id/activate-license'),
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard, roles_guard_1.RolesGuard),
    (0, roles_decorator_1.Roles)(roles_decorator_1.Role.SUPER_ADMIN, roles_decorator_1.Role.ADMIN_ECOLE),
    __param(0, (0, common_1.Param)('id')),
    __param(1, (0, common_1.Body)('licenseKey')),
    __param(2, (0, common_2.Request)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, String, Object]),
    __metadata("design:returntype", Promise)
], SchoolsController.prototype, "activateLicense", null);
