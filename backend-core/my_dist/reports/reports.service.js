...
let ReportsService = class ReportsService {
    ...
    async generateBulletin(schoolId, studentId, term, academicYearId, userRole = 'ELEVE') {
        ...
        if (!record) {
            throw new common_1.NotFoundException("L'eleve n'est inscrit dans aucune classe pour cette annee academique.");
        }
