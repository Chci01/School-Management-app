...
let RegistrationController = class RegistrationController {
    ...
    async activate(activateDto) {
        if (!activateDto.licenseKey) {
            throw new common_1.BadRequestException('Clé de licence manquante.');
        }
...
], RegistrationController.prototype, "signup", null);
__decorate([
    ...
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], RegistrationController.prototype, "activate", null);
